...
obj.handles.prune = uicontrol('Style','pushbutton',...
    ...
    'Callback',@obj.prune,...
    'Parent',obj.handles.hp);
obj.handles.filter = uicontrol('Style','pushbutton',...
    'String','Filter Traces',...
    'Units','points',...
    'ToolTipString','Filter traces',...
    'Callback',@obj.filter_rad,...
    'Parent',obj.handles.hp);
obj.handles.createDt = uicontrol('Style','pushbutton',...
    'String',['Create ',char(916),'t MOG'],...
    'Units','points',...
    'ToolTipString',['Create New Mog Holding ',char(916),'t Data'],...
    'Callback',@obj.createDt,...
    'Parent',obj.handles.hp);
obj.handles.createDa = uicontrol('Style','pushbutton',...
    'String',['Create ',char(916),char(964),' MOG'],...
    'Units','points',...
    'ToolTipString',['Create New Mog Holding ',char(916),'reduced amplitude Data'],...
    'Callback',@obj.createDa,...
    'Parent',obj.handles.hp);
obj.handles.showInfo = uicontrol('Style','pushbutton',...
    'String','Display Info',...
    'Units','points',...
    'ToolTipString','Display information about MOG',...
