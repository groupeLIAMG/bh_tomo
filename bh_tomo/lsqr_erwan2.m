function [x,residu_moy,residu_ecar]=lsqr_erwan2(L,dt,iter,epsilon,gradmin,correlmin,scont,x,l_moy,indi)
% [x,residu_moy,residu_ecar]=lsqr_erwan2(L,dt,iter,epsilon,gradmin,correlmin)
