function [S_sim,sco]=simu_contrainte3d(L,dt,covar,indc,nt,gridx,gridy,gridz,nsim,scont,mode,c0)
%%[S_sim,sco]=simu_contrainte3d(L,dt,covar,indc,nt,l_moy,gridx,gridy,gridz,nsim,scont,mode,c0);
%
